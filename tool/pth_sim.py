...
def parse_args():
    ...
    parser.add_argument('--in_file',default='/home/txy/code/CastPose/work_dirs/castpose_5_impove/best_coco_AP_epoch_135.pth', help='input checkpoint filename')
    parser.add_argument('--out_file',default='/home/txy/code/CastPose/work_dirs/castpose_5_impove/best_coco_AP_epoch_135_sim.pth', help='output checkpoint filename')
    parser.add_argument(
        '--save-keys',
        nargs='+',
        type=str,
