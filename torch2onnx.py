...
def parse_args():
    ...
    parser.add_argument('--deploy_cfg', help='deploy config path',
                        default='/home/txy/code/CastPose/mmdeploy/configs/mmpose/pose-detection_onnxruntime_static.py'
                        )
    parser.add_argument('--model_cfg', help='model config path',
                        default='/home/txy/code/CastPose/pic/rtmw-l_8xb320-270e_wholebody_384x288.py'
                        )
    parser.add_argument('--checkpoint', help='model checkpoint path',
                        default='/workspace/model_zoo/wholebody/rtmw-dw-x-l_simcc-cocktail14_270e-384x288-20231122.pth',
                        )
    parser.add_argument('--img', help='image used to convert model model',
                        default='/home/txy/code/CastPose/pic/frame_038080_1.PNG'
                        )
    parser.add_argument(
        '--test-img',
        default=None,
    ...
    parser.add_argument(
        '--work-dir',
        default='/home/txy/code/CastPose/results/hand/casthand',
    ...
    parser.add_argument(
        '--show', default=False, help='Show detection outputs')
    parser.add_argument(
...
def main():
    ...
    if backend == Backend.VACC:
        ...
        from tools.onnx2vacc_quant_dataset import get_quant
