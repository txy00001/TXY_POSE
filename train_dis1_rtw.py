...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path',default='/home/txy/code/CastPose/configs/castpose/castpose_dis1_rtw.py')
    parser.add_argument('--work-dir', help='the dir to save logs and models',
                        default='/home/txy/code/CastPose/work_dirs/dis_s1_rtw'
                        )
    parser.add_argument(
        '--resume',
        nargs='?',
