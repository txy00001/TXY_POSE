...
def parse_args():
    ...
    parser.add_argument('--deploy_cfg', default='/home/txy/code/CastPose/mmdeploy/configs/mmpose/pose-detection_tensorrt_dynamic-256x192.py')
    parser.add_argument('--onnx_path', default='/home/txy/code/CastPose/onnx/rtm_pose_onnx/rtmpose-l.onnx')
    parser.add_argument('--output_prefix', default='/home/txy/code/CastPose/output')
    parser.add_argument('--device-id', help='`the CUDA device id', default=1)
    parser.add_argument(
        '--calib-file',
