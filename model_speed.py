...
def parse_args():
    ...
    parser.add_argument('--model_cfg', default='/home/txy/code/CastPose/work_dirs/4_l/pose2.py')
    parser.add_argument('--image_dir', default='/home/txy/code/CastPose/pic/')
    parser.add_argument(
        '--model', type=str, nargs='+', default='/home/txy/code/CastPose/results/4_l_320/end2end.onnx')
    parser.add_argument(
