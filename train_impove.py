...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path',default='/home/txy/code/CastPose/castpose_dis2_dis1.py')
    parser.add_argument('--work-dir', help='the dir to save logs and models',
                        default='/home/txy/code/CastPose/work_dirs/castpose_whole_new'
                        )
    parser.add_argument(
        '--resume',
        nargs='?',
