...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(type='Lion', lr=base_lr, weight_decay=0.05,use_triton=True ),
    paramwise_cfg=dict(
...
model = dict(
    ...
    neck=dict(
      ...
      head=dict(
        ...
        #     type='Pretrained',
        #     prefix='head.',
        #     checkpoint='/home/txy/code/CastPose/work_dirs/u_our/best_PCK_epoch_112.pth'  # noqa
        #  ),
        ),
...
###u-body
# ubody_datasets = []
# u_scene = ['Magic_show', 'Entertainment', 'ConductMusic', 'Online_class', 
