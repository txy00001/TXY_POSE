...
#
# # 获取关键点个数
# NUM_KEYPOINTS = len(castpose53 ['keypoint_info'])
# print(len(castpose53 ['keypoint_info']))
# castpose53 ['joint_weights'] = [1.0] * NUM_KEYPOINTS
# castpose53 ['sigmas'] = [0.025] * NUM_KEYPOINTS