...
def main():
    ...
    parser.add_argument('--pose_config', default=r'C:\Users\ASUS\Desktop\CastPose\configs\castpose\yolox_l_det.py',help='Config file for detection')
    parser.add_argument('--pose_checkpoint', help='Checkpoint file')
    parser.add_argument('--img-root', type=str, default=r'C:\Users\ASUS\Desktop\CastPose\data\QX_COCO\test_coco\test_images', help='Image root')
    parser.add_argument(
        '--json-file',
        type=str,
        default=r'C:\Users\ASUS\Desktop\CastPose\data\people_json\COCO_val2017_detections_AP_H_56_person.json',
        help='Json file containing image person bboxes in COCO format.')
    parser.add_argument(
        '--out-json-file',
        type=str,
        default=r'C:\Users\ASUS\Desktop\CastPose\output\out.json',
