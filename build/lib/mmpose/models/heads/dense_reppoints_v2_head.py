...
from mmdet.models import AnchorFreeHead, build_assigner, build_sampler, fast_nms
from mmdet.models.task_modules import PointGenerator
from mmdet.models.utils import multi_apply, unmap, images_to_levels
...
@HEADS.register_module(name="DenseRepPointsV2Head",force=True)
class DenseRepPointsV2Head(AnchorFreeHead):
    ...
    def _get_bboxes_single(self,
        ...
        if nms:
            det_bboxes, det_pts, det_pts_refine, det_masks, det_masks_refine, det_labels = fast_nms(
