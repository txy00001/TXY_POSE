...
from tricks.txy_conv.conv import ConvModule
from tricks.txy_conv.init_weights import xavier_init




class AAM(nn.Module):
    def __init__(self, feature_map_shape, pool_nums=3, in_channels=1024, out_channels=1024):
...
if __name__ == '__main__':
    ...
    # af_fpn = TXYFPN(in_channels=in_channels, out_channels=out_channels, num_outs=num_outs, activation=activation)
    # # torch.save(af_fpn.state_dict(), "TXY_fpn.ckpt")
    # #
