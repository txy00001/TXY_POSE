...
class RTMPose:
    ...
    def __init__(self, type: str = "m", device: str = "cpu") -> None:
        ...
        onnx_file = Path(r"C:\Users\ASUS\Desktop\CastPose\onnx\dw_pose.onnx")
        ...
        #         dir=Path(f"model/"),
        deploy_cfg = (
            r"C:\Users\ASUS\Desktop\CastPose\mmdeploy\config\mmpose\pose-detection_onnxruntime_static.py"
        )
